                ...
                <>
                  <Row>
                    ...
                    <Col>
                      ...
                      <Text small>
                        Endpoint utilisé pour envoyer une requête POST lorsqu'il
                        y a un changement d'URL dans l'application. Il envoie
                        les informations sur la page visitée, l'utilisateur, le
                        navigateur et le système d'exploitation utilisés.
                      </Text>
                      <Spacer y={1} />
                      ...
                      <Text small>
                        ...
                        envoie les informations sur la position du clic, la
                        fenêtre du navigateur, la page visitée, l'utilisateur,
                      ...
                      <Text small>
                        ...
                        l'utilisateur, telles que son adresse IP. Ces données
                        sont récupérées à partir de l'API externe
                        "https://api.ipify.org".
                      </Text>
                    </Col>
                  </Row>
